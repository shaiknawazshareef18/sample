...
function Register() {
    ...
    const handleRegister = () => {
        ...
        if(firstname === null || middlename === null || lastname === null || email === null || password === null || rePassword === null ||
           firstname === '' || middlename === '' || lastname === '' || email === '' || password === '' || rePassword === ''){
    ...
    return (
        ...
        <Dialog open={open2} onClose={()=>setOpen2(false)}>
            ...
            <DialogContent>
                Your account has been created, don't forget to verify your email for you to login with your account.
            </DialogContent>
            <DialogActions>
                <Button 
                    color='primary' 
